...
type
  ...
  TMaskMaker = function(width: Integer; const s, d: PByte): Integer;
  ...
  begin
    ...
    begin
      if (s^ and $80) <> 0 then
        ...
        case mask of
          mtMask0: exp := (x + y) and 1;
          mtMask1: exp := y and 1;
          mtMask2: exp := x mod 3;
          mtMask3: exp := (x + y) mod 3;
          mtMask4: exp := ((y div 2) + (x div 3)) and 1;
          mtMask5: exp := ((x * y) and 1) + (x * y) mod 3;
          mtMask6: exp := (((x * y) and 1) + (x * y) mod 3) and 1;
          mtMask7: exp := (((x * y) mod 3) + ((x + y) and 1)) and 1;
        else
          exp := 0;
        end;
        if exp = 0 then
...
function Mask_mask0(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask0);
end;

function Mask_mask1(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask1);
end;

function Mask_mask2(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask2);
end;

function Mask_mask3(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask3);
end;

function Mask_mask4(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask4);
end;

function Mask_mask5(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask5);
end;

function Mask_mask6(width: Integer; const s, d: PByte): Integer;
begin
	Result := Mask_Maker(width, s, d, mtMask6);
end;

function Mask_mask7(width: Integer; const s, d: PByte): Integer;
begin
